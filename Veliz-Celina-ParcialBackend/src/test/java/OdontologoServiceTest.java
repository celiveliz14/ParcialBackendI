...
public class OdontologoServiceTest {
    ...
    public void test4() {
        ...
        for (int i = 0; i < testRecords; i++) {
            ...
            var apellido = "Fernandez";
            Random rand = new Random();
            var matricula = String.valueOf(rand.nextInt(10000));
            Odontologo odontologo = new Odontologo(nombre, apellido, matricula);
            var serviceA = new OdontologoService(new OdontologoDAOH2());
            serviceA.guardar(odontologo);}



        //WHEN
        var serviceB = new OdontologoService();
        int encontrados = serviceB.buscartTodos().size();
